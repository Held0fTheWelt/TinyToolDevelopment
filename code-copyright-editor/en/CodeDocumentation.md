...
| --- | --- | --- |
| `FCodeCopyrightEditorModule` | `Public/CodeCopyrightEditor.h` | Registers runtime/editor settings, the editor tab, and the Tiny Tools menu entry. |
...
| --- | --- |
| `CodeCopyrightEditor.cpp` | Minimal editor-module glue: settings registration, tab creation, and Tiny Tools menu integration. |
