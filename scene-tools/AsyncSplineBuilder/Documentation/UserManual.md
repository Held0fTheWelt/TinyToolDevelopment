...
- **Build**: actor selection, mesh setup, validate/build/rebuild/cancel, async batching, closed loop, and debug point or segment labels.
...
- It does not paint landscape material layers yet.
