...
Run an isolated plugin build with strict includes from your installed Unreal Engine. A full project build can hide missing includes through transitive headers.
