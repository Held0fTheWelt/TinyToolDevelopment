...
> **For maintainers:** source-repository validation checks are not part of the Fab package and are
> not needed to author or validate your own manifest integration.
