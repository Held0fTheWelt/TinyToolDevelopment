...
- Native Track Shape Editor for main, pit-lane, alternate, and service-road layout authoring.
...
Position the plugin as a practical production helper, not a AAA road-authoring suite. The fair price depends on documentation, examples, and polish:

- Low price tier: simple spline mesh builder with basic docs.
- Mid price tier: async rebuilds, walls, gaps, drops, examples, automation, strong docs.
- High price tier: full landscape layer painting, advanced shoulder materials, UI tooling, and multiple production-ready demo maps.

With the current feature set, the mid tier is the honest target.
