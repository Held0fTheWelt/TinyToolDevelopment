...
- [BuyerGuide.md](BuyerGuide.md): buyer-friendly overview, included value, and common production workflows.
...
- [AutomationAndCI.md](AutomationAndCI.md): isolated BuildPlugin validation, strict includes, and CI notes.
- [TechnicalOverview.md](TechnicalOverview.md): maintainer-level architecture, module responsibilities, and apply/restore flow.
...
- [ReleaseChecklist.md](ReleaseChecklist.md): validation checklist for plugin releases and Fab submissions.
...
3. Select a preset from the list. Use **Refresh** if new preset assets were just created or imported.
...
For marketplace and release validation, build the plugin in isolation with strict includes:
...
This catches missing includes and packaging mistakes earlier than a normal project build.
