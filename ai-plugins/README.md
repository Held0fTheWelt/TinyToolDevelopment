...
| Project Intelligence Orchestrator | Internal/preview UCM-first workflow runner for deterministic manifests, approval-gated composition, verification reports, and reconstructable journals. | [Overview](ProjectIntelligenceOrchestrator/README.md) | Internal preview |
...
| Unreal Blueprint Integrator | Deterministic Blueprint evidence export plus approval-gated Blueprint and DataAsset mutation with preview, backup, apply, and rollback. | [Overview](UnrealBlueprintIntegrator/README.md) | Not listed yet |
