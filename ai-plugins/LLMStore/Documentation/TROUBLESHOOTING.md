...
- Unreal was launched from an environment that can see the executable
- adapter status check knows the correct executable name
...
LLM Store does not store the credentials. It only shows and copies the setup command for the external login.
