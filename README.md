...
| Scene Plugins | [scene-plugins](scene-plugins/README.md) | Scene-facing runtime plugins and representation systems with dedicated public landing pages. |
...
| Game Featured Classes | Scene Tools | Runtime module shell for featured gameplay classes; premium GameFeature Workbench remains target-only. | [Overview](scene-tools/GameFeaturedClasses/README.md) | Not listed yet |
| Lightweight Dummy Actor System | Scene Tools | Autonomous dummy-actor representation with readiness gates, promotion/demotion, inspector, and validate commandlet. | [Overview](scene-tools/LightweightDummyActorSystem/README.md) | Not listed yet |
...
| Editor Extension Base | Editor Tools | Shared editor widgets and selection/checkout helpers used by Tiny Tool editor plugins. | [Overview](editor-tools/EditorExtensionBase/README.md) | Not listed yet (internal foundation) |
